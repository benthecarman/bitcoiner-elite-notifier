...
object CommonSettings {
  ...
  lazy val settings: Vector[Setting[_]] = Vector(
    version := "0.1.0",
    scalaVersion := "2.13.6",
    organization := "com.ben",
    homepage := Some(
      url("https://github.com/benthecarman/bitcoiner-elite-notifier")),
    maintainer.withRank(
